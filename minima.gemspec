...
Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE.txt".freeze, "README.md".freeze, "_includes/custom-head.html".freeze, "_includes/disqus_comments.html".freeze, "_includes/footer.html".freeze, "_includes/google-analytics.html".freeze, "_includes/head.html".freeze, "_includes/header.html".freeze, "_includes/social.html".freeze, "_layouts/default.html".freeze, "_layouts/home.html".freeze, "_layouts/page.html".freeze, "_layouts/post.html".freeze, "_sass/minima/_base.scss".freeze, "_sass/minima/_layout.scss".freeze, "_sass/minima/custom-styles.scss".freeze, "_sass/minima/custom-variables.scss".freeze, "_sass/minima/initialize.scss".freeze, "_sass/minima/skins/classic.scss".freeze, "_sass/minima/skins/dark.scss".freeze, "_sass/minima/skins/solarized-dark.scss".freeze, "_sass/minima/skins/solarized.scss".freeze, "assets/css/style.scss".freeze, "assets/minima-social-icons.svg".freeze]
